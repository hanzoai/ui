...
describe('chat shell renders', () => {
  ...
  /**
   * A string child has to reach a Text host, or it does not render on native.
   *
   * Asserted on the slot gui stamps on that host, not on the absence of a
   * console warning — a warning assertion passes the day it is reworded.
   */
  ...
  it('caps a user turn at 85%', () => {
    // gui compiles the percentage into the class name; jsdom measures no width.
