...
// @hanzo/canvas (a pannable/zoomable board of service nodes with live status,
// metric sparklines, deploy timelines, an environment switcher and a service
// detail drawer). Kept as a thin subpath so a console can
//
