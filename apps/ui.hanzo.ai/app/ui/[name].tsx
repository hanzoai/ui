...
const modules = import.meta.glob('../../examples/*.tsx', { eager: true }) as Record<string, Record<string, ComponentType>>

export default function Page() {
  const doc = useLoader(loader)
  return <Module doc={doc} examples={modules[`../../examples/${doc.name}.tsx`] ?? {}} />
}
